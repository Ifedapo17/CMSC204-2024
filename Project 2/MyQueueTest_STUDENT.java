...
public class MyQueueTest_STUDENT {
	...
	public double g = 0, h = 0, i = 0, j = 0, k = 0, l = 0;
	...
	public void testToStringStudent() throws QueueOverflowException{
		//Use the doubleQ for student tests
		// assertEquals("000", stringQ.toString()); ERROR! Should be doubleQ
		assertEquals("0.00.00.0", doubleQ.toString()); // SEE HOW DOUBLES PRINT AS 0.0 INSTEAD OF 0 (INTEGERS)
		doubleQ.enqueue(j);
		// assertEquals("0000", stringQ.toString()); ERROR! Should be doubleQ 
		assertEquals("0.00.00.00.0", doubleQ.toString()); // SEE HOW DOUBLES PRINT AS 0.0 INSTEAD OF 0 (INTEGERS)
		doubleQ.enqueue(k);
		// assertEquals("00000", stringQ.toString()); ERROR! Should be doubleQ
		assertEquals("0.00.00.00.00.0", doubleQ.toString()); // SEE HOW DOUBLES PRINT AS 0.0 INSTEAD OF 0 (INTEGERS)
	}
